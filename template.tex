\begin{filecontents*}[overwrite]{glex.cls}
%% glex.cls - GLEX Conference Paper Class (2025)
%======================================================================================
%                                   CLASS CONFIGURATION
%======================================================================================
\NeedsTeXFormat{LaTeX2e}
\ProvidesClass{glex}[2025 GLEX conference paper LaTeX class]
...
\RequirePackage{xurl}                                   
% Bibliography
\RequirePackage[backend=biber,style=\glex@bibstyle,citestyle=numeric-comp]{biblatex}
...
%======================================================================================
%                                GLEX-SPECIFIC ELEMENTS
%======================================================================================
% Author tracking
\newcounter{authcount}
\newcounter{contactauthor}
\NewDocumentCommand{\authorGLEX}{ s m m m }{%
    \stepcounter{authcount}%
    \csdef{glex@author\theauthcount}{#2}%
    \csdef{glex@affiliation\theauthcount}{#3}%
    \csdef{glex@email\theauthcount}{#4}%
...
% Conference metadata
\newcommand*{\ConfInfo}[1]{\def\glex@conference{#1}}\ConfInfo{}
\newcommand*{\ConfLoc}[1]{\def\glex@location{#1}}\ConfLoc{}
\newcommand*{\dateofGLEX}[1]{\def\glex@dates{#1}}\dateofGLEX{}
\newcommand*{\yearofGLEX}[1]{\def\glex@year{#1}}\yearofGLEX{}
\newcommand*{\Papernumber}[1]{\def\glex@papernumber{#1}}\Papernumber{}
\newcommand{\copyrightIAFIAC}[2]{\def\glex@copyright{Copyright \copyright\,#1 by #2. All rights reserved.}}
...
\fancypagestyle{fancy}{%
    \chead{{\footnotesize\color{gray}%
        Global~Space~Exploration~Conference~(GLEX 2025),~\glex@location,~\glex@dates~\glex@year.\\%
        \glex@copyright%
    }}%
    \lhead{}%
    \rhead{}%
    \renewcommand{\headrulewidth}{0pt}%
    \lfoot{{\color{gray}GLEX--\yearshorthand{\glex@year}--\glex@papernumber}}%
    \cfoot{}%
...
\def\@maketitle{%
    {\centering%
        GLEX--\yearshorthand{\glex@year}--\glex@papernumber\par%
        \vskip1em
        ...
        \begin{center}%
            ...
            \whileboolexpr{ test {\ifnumcomp{\value{authnum}}{<}{\theauthcount}} }{%
                \stepcounter{authnum}%
                \mbox{%
                    \normalfont\textbf{\csuse{glex@author\theauthnum}\textsuperscript{\alph{authnum}}}%
    ...
    {\small\itshape\selectfont%
        ...
        \whileboolexpr{ test {\ifnumcomp{\value{authnum}}{<}{\theauthcount}} }{%
            \stepcounter{authnum}%
            \parbox{0.75em}{\normalfont\textsuperscript{\alph{authnum}}}\csuse{glex@affiliation\theauthnum},~\uline{\csuse{glex@email\theauthnum}}\par
        }%
        \parbox{0.75em}{\textsuperscript{*}}Corresponding author
    }%
    \vskip 1em%
    \indent\glex@abstract\par%
    \vskip 4.5ex
}
\end{filecontents*}
